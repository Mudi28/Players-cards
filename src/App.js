...
function App() {
  ...
  const handleOnChange = (e) => {
    ...
    if (value.length > 2) {
      let list = filteredPopulation.filter((person) =>
        person.name.toLowerCase().includes(value.toLowerCase())
      );

      let search = arraySearch(population, value, (person) =>
              ...
              <div className="all">
                ...
                <form onSubmit={handleSubmit} className="form-group">
                  ...
                  >
                    ...
                    <option value="the best fifa men's player">
                            ...
                            <table className="table">
                              <tbody>
                                <tr>
                                  ...
                                  <th>
                                    Ballon D'Or:[{person["pallonedoro"]}]{" "}
                                  </th>
                                  <th>
                                    FIFA WP of the Year:[
                                  ...
                                  <th>
                                    Golden Boots: [{person["goldenboots"]}]
                                  </th>
                                  <th>
                                    The Best FIFA Men’s Player: [
                                    {person["thebestfifamensplayer"]}]
